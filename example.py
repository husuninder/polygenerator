...
plot_polygon(polygon, "random_polygon.png", show=True)


polygon = random_star_shaped_polygon(num_points=20)
plot_polygon(polygon, "random_star_shaped_polygon.png", show=True)


polygon = random_convex_polygon(num_points=20)
plot_polygon(polygon, "random_convex_polygon.png", show=True)
